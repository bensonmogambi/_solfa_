...
import 'package:flutter_solfapay_ui/model/Gridmodel.dart';
import 'package:flutter_solfapay_ui/model/ImageSliderModel.dart';
import 'package:flutter_swiper/flutter_swiper.dart';

class Paytm extends StatefulWidget {
  @override
  _SolfapayState createState() => _PaytmState();
}

class _SolfapayState extends State<Solfapay> {
  int _currentIndex = 0;
...
//            ),
  ...
  List<GridModel> _getGridList() {
    ...
    list.add(new GridModel(
        "assets/calendar_blue.png", "Solfapay\nPostpaid", Colors.white));
    list.add(new GridModel(
